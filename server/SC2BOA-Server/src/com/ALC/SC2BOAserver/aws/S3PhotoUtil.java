...
//import com.ALC.SC2BOAserver.entity.Photo;
...
public class S3PhotoUtil {
    ...
    private static void deleteFromPath (String path) {
        ...
        SC2BOAStorageObject obj = new SC2BOAStorageObject();
     ...
     * @return
     */
    private static SC2BOAStorageObject getStorageObject (byte [] data, String storagePath) {
        SC2BOAStorageObject obj = new SC2BOAStorageObject();
        obj.setData(data);
        obj.setBucketName(uniqueBucketName);
