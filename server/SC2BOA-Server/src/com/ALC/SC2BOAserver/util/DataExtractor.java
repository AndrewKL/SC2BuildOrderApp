 ...
 */
package com.ALC.SC2BOAserver.util;
...
public class DataExtractor implements Runnable {
     ...
     */
    public DataExtractor (String outputPath, SC2BOADAO dao) {
     ...
     * @param dao DAO to read in the data for export
     */
    public DataExtractor (String bucketName, String storagePath, SC2BOADAO dao) {
    ...
    private Properties buildProps (OnlineBuildOrder buildorder)  {
        Properties props = new Properties();
        props.setProperty("buildname",buildorder.getBuildName());
        props.setProperty("buildorderinstructions",buildorder.getBuildOrderInstructions());
        props.setProperty("race", buildorder.getRace());
        //props.setProperty("start_date",formatter.format(buildorder.getStartDate()));
        //props.setProperty("end_date",formatter.format(buildorder.getEndDate()));
        return props;
