      ...
      <div class="sc2boa_popup" id="createAccount">
		...
		<div class="sc2boa_popup" id="journal_div" >
      ...
      <div class="sc2boa_popup" id="entry_div">
      		<H1>Edit Entry</H1>
      		<div class="popupForm">
	  ...
	  <div class="sc2boa_popup" id="photo_div">
	  		<H1>Upload Photo</H1>
      ...
      <div class="sc2boa_popup" id="comment_div">
      		<h1>Add Comment</h1>
      ...
      <div id="login_div" class="sc2boa_popup">
      	<h1>Sign in</h1>
      ...
      <div id="manage_div" class="sc2boa_popup">
