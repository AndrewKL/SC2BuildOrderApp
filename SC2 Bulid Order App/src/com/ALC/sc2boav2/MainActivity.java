...
public class MainActivity extends Activity {
	...
	private static final int server = PayPal.ENV_LIVE;//sandbox for now // The PayPal server to be used - can also be ENV_NONE and ENV_LIVE
	private static final String appID = "APP-9L199909E9404053E";//"APP-80W284485P519543T"; // The ID of your application that you received from PayPal//APP-80W284485P519543T == paypal sandbox id
	private static final String paypalRecipient = "andrew.long.3001@gmail.com";
	public final static String EXTRA_MESSAGE = "com.alc.sc2boav2.MESSAGE";
	public final static String EXTRA_RACE = "com.alc.sc2boav2.RACE";
    ...
    private class Donate extends AsyncTask<Void,Void,Void>{
	    ...
	    protected void onPostExecute(final Void result) {
		    ...
		    payment.setRecipient(paypalRecipient); // Sets the recipient for the payment. This can also be a phone number.
